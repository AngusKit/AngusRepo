...
import static cloud.xcan.angus.api.commonlink.GMConstant.SYS_TOKEN_CLIENT_DESC_FMT;
import static cloud.xcan.angus.api.commonlink.GMConstant.SYS_TOKEN_CLIENT_ID_FMT;
...
public class AuthorizationClientConverter {
  ...
  private static Duration getExpireSecond(LocalDateTime expireDate) {
    if (isNull(expireDate)) {
      return Duration.ofSeconds(GMConstant.DEFAULT_TOKEN_EXPIRE_SECOND);
    }
