...
public class SmsTemplateCreateDto {
  ...
  @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "系统通知模板")
  private String name;

  @NotBlank
  @Length(max = MAX_CODE_LENGTH)
  @Schema(description = "模板编码", requiredMode = Schema.RequiredMode.REQUIRED, example = "SYSTEM_NOTIFY")
  private String code;
  ...
  @Schema(description = "模板内容", requiredMode = Schema.RequiredMode.REQUIRED, example = "【AngusGM】尊敬的{name}，{event}将于{time}进行，请知悉。")
  ...
  @Length(max = MAX_NAME_LENGTH)
  @Schema(description = "签名", example = "【AngusGM】")
