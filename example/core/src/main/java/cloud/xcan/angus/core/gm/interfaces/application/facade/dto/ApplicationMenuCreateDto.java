...
@Schema(description = "创建应用菜单请求参数")
public class ApplicationMenuCreateDto implements Serializable {

  @NotBlank
  @Length(max = MAX_NAME_LENGTH)
  @Schema(description = "菜单完整名称", requiredMode = Schema.RequiredMode.REQUIRED)
  private String name;
