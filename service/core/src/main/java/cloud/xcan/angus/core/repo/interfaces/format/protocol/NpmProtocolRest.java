...
public class NpmProtocolRest {
  ...
  public ResponseEntity<?> getPackageDocument(@Parameter(name = "repositoryName", description = "仓库名称") @PathVariable String repositoryName,
  ...
  public ResponseEntity<?> getPackageVersion(@Parameter(name = "repositoryName", description = "仓库名称") @PathVariable String repositoryName,
  ...
  public ResponseEntity<?> downloadTarball(@Parameter(name = "repositoryName", description = "仓库名称") @PathVariable String repositoryName,
  ...
  public ResponseEntity<?> publish(@Parameter(name = "repositoryName", description = "仓库名称") @PathVariable String repositoryName,
      @Parameter(name = "packageName", description = "包名称") @PathVariable String packageName, HttpServletRequest request) throws IOException {
    RepoEntity repository = repositoryQuery.findByNameAndCheck(repositoryName);
    validateFormat(repository, RepositoryFormat.NPM);
  ...
  public ResponseEntity<?> unpublish(@Parameter(name = "repositoryName", description = "仓库名称") @PathVariable String repositoryName,
      @Parameter(name = "packageName", description = "包名称") @PathVariable String packageName, @Parameter(name = "rev", description = "rev") @PathVariable String rev) {
    RepoEntity repository = repositoryQuery.findByNameAndCheck(repositoryName);
    validateFormat(repository, RepositoryFormat.NPM);
    validateHosted(repository);
  ...
  public ResponseEntity<?> setDistTag(@Parameter(name = "repositoryName", description = "仓库名称") @PathVariable String repositoryName,
      @Parameter(name = "packageName", description = "包名称") @PathVariable String packageName, @Parameter(name = "tag", description = "tag") @PathVariable String tag,
